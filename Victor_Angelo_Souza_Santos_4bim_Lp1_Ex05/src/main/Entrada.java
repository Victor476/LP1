...
public class Entrada {
    ...
    public Date lerData(String msg) {
        ...
        while (true) {
            try {
                 System.out.print(msg + " =>");
                Date outraData = cf.converteDeStringParaDate
                (teclado.nextLine());
                if (outraData==null) {
                    int k = 3 / 0; //propositalmente provoca um erro para ir para o catch
                }
                ...
                System.out.println("Erro, a data deve estar no formato "
                        + "dd/MM/yyyy");
                teclado = new Scanner(System.in);
            }
        }
    ...
    public boolean lerSexo(String msg) {
        teclado = new Scanner(System.in);
        //ler uma resposta sim ou não do usuário
        while (true) {
            try {
                System.out.print(msg + " (M ou F) ");
                char x = teclado.next().charAt(0);
                if (x == 'm' || x == 'M') {
                    return true;
                } else if (x == 'f' || x == 'F') {
                ...
                System.out.println("Erro, são válidas as letras M ou F");
                teclado = new Scanner(System.in);
            }
        }
    }
