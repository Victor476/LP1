...
public class GUI extends JFrame {
    ...
    private JLabel cbCor = new JLabel("Cor");
    ...
    private Estrela estrela = new Estrela();

    String[] colunas = new String[]{"Id", "Nome", "Endereço", "Cor"};
    ...
    public GUI() {
        ...
        String caminhoENomeDoArquivo = "DadosEstrela.csv";
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (manipulaArquivo.existeOArquivo(caminhoENomeDoArquivo)) { //só dá para carregar dados se o arquivo existir
                    ...
                    for (String linha : listaStringCsv) {//para cada linha da lista
                        ...
                        t = new Estrela(Long.valueOf(aux[0]), aux[1], Double.valueOf(aux[2]), aux[3],cf.converteDeStringParaDate(aux[4]));//crie um objeto Estrela e preencha com dados.
        ...
        btGravar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //1) converter de uma list<estrela> para list<string>
                List<Estrela> listaEstrela = controle.listar();//obtem a lista toda
                List<String> listaEstrelaEmFormatoStringCSV = new ArrayList<>();
                for (Estrela t : listaEstrela) { //percorre toda a lista de estrelaes
                    listaEstrelaEmFormatoStringCSV.add(t.toString());//para cada estrela t, transforme em string.
                }
                new ManipulaArquivo().salvarArquivo(caminhoENomeDoArquivo, listaEstrelaEmFormatoStringCSV);
        ...
        btBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tfId.getText().trim().isEmpty()) {
                    ...
                    estrela = controle.buscar(tfId.getText);
                    if (estrela == null) {//nao encontrou
                        ...
                        tfNome.setText(estrela.getNome());
                        tfSalario.setText(String.valueOf(estrela.getMassa()));
                        cbCor.setText(estrela.getCor());
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (acao.equals("alterar")) {
                    Estrela estrelaAntigo = estrela;
                    estrela.setNome(tfNome.getText());
                    estrela.setMassa(Double.valueOf(tfSalario.getText()));
                    estrela.setCor(cbCor.getText());
                    controle.alterar(estrela, estrelaAntigo);
                    texto.setText("Registro alterado\n\n\n\n\n");//limpa o campo texto
                } else {//adicionar
                    estrela = new Estrela();
                    estrela.setId(tfId.getText());
                    estrela.setNome(tfNome.getText());
                    estrela.setMassa(Double.valueOf(tfSalario.getText()));
                    estrela.setCor(cbCor.getText());
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (JOptionPane.YES_OPTION
                        == JOptionPane.showConfirmDialog(null,
                                "Confirma a exclusão do registro <Nome = " + estrela.getNome() + ">?", "Confirm",
                ...
                btExcluir.setVisible(false);
                btAlterar.setVisible(false);
                texto.setText("Excluiu o registro de " + estrela.getId() + " - " + estrela.getNome() + "\n\n\n\n\n");//limpa o campo texto
            }
        });
...
//                };
                String[] colunas = {"Id", "Nome", "Salário", "Cor"};
